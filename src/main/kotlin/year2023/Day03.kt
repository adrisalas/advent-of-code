...
private data class Point(val row: Int, val column: Int, val value: Int)
 ...
 */
private fun encapsulateMatrixWithDots(matrix: List<String>): List<String> {
...
private fun findPointAt(matrix: List<String>, row: Int, column: Int): Point? {
...
private fun findAdjacentPointsTo(matrix: List<String>, row: Int, column: Int): Set<Point> {
